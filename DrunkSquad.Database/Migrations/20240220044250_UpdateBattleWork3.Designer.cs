...
namespace DrunkSquad.Database.Migrations
{
    ...
    [Migration("20240220044250_UpdateBattleWork3")]
    partial class UpdateBattleWork3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TornApi.Net.Models.User.BattleStats", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TornApi.Net.Models.User.WorkingStats", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WorkinStatsID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.ToTable("WorkingStats");
                });
